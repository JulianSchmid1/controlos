    ...
    type: "sections", max_columns: 4, sections: [
      ...
      { type: "grid", cards: [
        ...
        V(bslider(np + "ki_ff_staerke", "Stärke des Eingriffs"),
          cOn(wp + "ki_vorsteuerung")),
        V(bslider(np + "ki_ff_max_mae", "MAE-Grenze (Modellgüte)"),
          cOn(wp + "ki_vorsteuerung")),
      ] },
      { type: "grid", cards: [
        ...
        V(bsel(sp + "klima_fan_nacht", "AC-Lüfter Nacht"), cOn(wp + "vorhanden_klima"),
          cEq(sp + "klima_steuermodus", "Autonom")),
        // Sensor-Modi: Luefter je Zustand (aktiv Heizen/Kuehlen vs. Leerlauf)
        V(bsel(sp + "klima_fan_aktiv", "AC-Lüfter aktiv (Heizen/Kühlen)"),
          cOn(wp + "vorhanden_klima"),
          { condition: "state", entity: sp + "klima_steuermodus", state_not: "Autonom" }),
        V(bsel(sp + "klima_fan_leerlauf", "AC-Lüfter Leerlauf (nur Lüfter)"),
          cOn(wp + "vorhanden_klima"),
          { condition: "state", entity: sp + "klima_steuermodus", state_not: "Autonom" }),
